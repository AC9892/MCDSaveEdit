...
namespace MCDSaveEdit.UI
{
    ...
    public partial class InventoryTab : UserControl
    {
        ...
        private static readonly BitmapImage? _enchantmentPointsImage = ImageResolver.instance.imageSource("/Dungeons/Content/UI/Materials/Inventory2/Enchantment/enchant_counter");
        ...
        {
            InitializeComponent();
            itemListScreen.modernPresentation = true;
        ...
        private void useGameContentImages()
        {
            ...
            remainingEnchantmentPointsLabelImage.Source = _enchantmentPointsImage;
        }
        ...
        private void emeraldsTextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (ulong.TryParse(emeraldsTextBox.Text, out ulong emeralds))
            {
        ...
        private void goldTextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (ulong.TryParse(goldTextBox.Text, out ulong gold))
            {
        ...
        private void eyeOfEnderTextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (_model?.profile.value == null || !eyeOfEnderTextBox.IsEnabled)
                return;
            if (ulong.TryParse(eyeOfEnderTextBox.Text, out ulong eyeOfEnder))
            {
        ...
        {
            // Portal editing is presented on the Character page. Keeping this legacy
            // button collapsed prevents its text from covering the enchant-points icon.
